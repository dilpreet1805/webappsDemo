	...
	<div class="small-container single-product">
		<div class="row">
			...
			<div class="col-2">
				...
				<br>
				<p>Give your summer wordrobe a style upgrade with the HRX Men's Active T-Shirt. Team it with pair of shorts for your morning workout or a denims for an evening out with the guys.</p>
			</div>
		</div>
	</div>
	<!------Title------>
